       ...
       if strcmp(instant.textdata(i,2),'r')
               for j = 1:2: size(instant.data,2)
                   if instant.data(i,j)>0
                       HeelContact = line([instant.data(i,j) instant.data(i,j)], [-2 100],...
                           'Color',[0 0 1]);
                       ToeOff = line([instant.data(i,j+1) instant.data(i,j+1)], [-2 100],...
        ...
        if strcmp(instant.textdata(i,2),'l')
               for j = 1:2: size(instant.data,2)
                   if instant.data(i,j)>0
                       HeelContact = line([instant.data(i,j) instant.data(i,j)], [-5 100],...
                           'Color',[1 0 0]);
                       ToeOff =line([instant.data(i,j+1) instant.data(i,j+1)], [-5 100],...
